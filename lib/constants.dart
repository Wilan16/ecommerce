...
final passwordValidator = MultiValidator([
  ...
  MinLengthValidator(8, errorText: 'Password berisi setidaknya 8 karakter'),
  PatternValidator(r'(?=.*?[#?!@$%^&*-])',
      errorText: 'password berisi setidaknya 1 karakter spesial')
]);

final emaildValidator = MultiValidator([
  RequiredValidator(errorText: 'Email wajib diisi'),
  EmailValidator(errorText: "Masukkan email yang valid"),
]);
